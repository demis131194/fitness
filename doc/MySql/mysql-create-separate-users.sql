...
(
    ...
    status          INT             DEFAULT 0 CHECK (status >=0 AND status <=5),
    active          BOOLEAN         NOT NULL DEFAULT true,
    PRIMARY KEY (id),
...
VALUES (4, 2, '2015-08-21 10:16:43', 'Training-1! cl-tr : 4-2', 'Nutrition-1', '2015-08-21', '2016-08-21', 100, 'Comment-1', 0, 1),
       (6, 3, '2016-03-21 10:28:02', 'Training-2! cl-tr : 6-3', 'Nutrition-2', '2016-03-21', '2017-03-21', 250, 'Comment-2', 0, 1),
       (7, 3, '2016-06-01 09:51:22', 'Training-3! cl-tr : 7-3', 'Nutrition-3', '2016-06-01', '2017-06-01', 150, 'Comment-3', 0, 1);
