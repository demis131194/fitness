...
public class PagePath {
    ...
    public static final String ADMIN_ACCOUNT_PATH = "jsp/pages/admin/account.jsp";
    ...
    public static final String TRAINER_ACCOUNT_PATH = "jsp/pages/trainer/account.jsp";
    ...
    public static final String CLIENT_ACCOUNT_PATH = "jsp/pages/client/account.jsp";
