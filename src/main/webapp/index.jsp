...
<body>
<c:import url="jsp/fragment/heder.jsp"/>
<ul>
    <c:if test="${user!=null}" >
        <li><a href="pages/welcome.jsp"><fmt:message key="index.welcome" bundle="${rb}"/></a></li>
    </c:if>
    <c:if test="${user==null}" >
        <li><a href="pages/login.jsp"><fmt:message key="index.login" bundle="${rb}"/></a></li>
    </c:if>
