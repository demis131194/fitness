...
<fmt:message key="comment.restored.title" bundle="${rb}" var="commentRestoredTitle"/>
<fmt:message key="comment.restored.text" bundle="${rb}" var="commentRestoredText"/>
        ...
        <div class="main-section">
            <div class="сщььуте-deleted">
                <div class="col-lg-10 offset-lg-1">
                    <h2 class="order-deleted-title">${commentRestoredTitle}</h2>
                    <p>${commentRestoredText} ${requestScope.commentId}</p>
