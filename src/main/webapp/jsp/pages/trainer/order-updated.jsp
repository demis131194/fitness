...
<fmt:message key="order.updated.title" bundle="${rb}" var="orderUpdatedTitle"/>
<fmt:message key="order.updated.text" bundle="${rb}" var="orderUpdatedText"/>
        ...
        <div class="main-section">
            <div class="order-created">
                <div class="col-lg-10 offset-lg-1">
                    <h2 class="order-created-title">${orderUpdatedTitle}</h2>
                    <p>${orderUpdatedText}</p>
