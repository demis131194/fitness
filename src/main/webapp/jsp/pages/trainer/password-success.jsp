...
<head>
    ...
    <meta http-equiv="refresh" content="5;${pageContext.request.contextPath}/jsp/pages/trainer/account/profile.jsp">
</head>
<body>
        ...
        <div class="main-section">
            <div class="order-created">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <a href="${pageContext.request.contextPath}/jsp/pages/trainer/account/profile.jsp">${profile}</a>
                </div>
            </div>
        </div>
    </div>
